...
from geta.tutorials.src.rfdetr.config import TrainConfig
from geta.tutorials.src.rfdetr.models import PostProcess, build_model
from geta.tutorials.src.rfdetr.models.weights import apply_lora, load_pretrain_weights

if TYPE_CHECKING:
    from geta.tutorials.src.rfdetr.config import ModelConfig
...
def _build_model_context(model_config: ModelConfig) -> ModelContext:
    ...
    """
    from geta.tutorials.src.rfdetr._namespace import _namespace_from_configs
