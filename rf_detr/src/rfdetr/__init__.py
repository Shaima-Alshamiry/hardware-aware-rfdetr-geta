...
from geta.tutorials.src.rfdetr.detr import RFDETR
from geta.tutorials.src.rfdetr.inference import ModelContext
from geta.tutorials.src.rfdetr.variants import (
...
def __getattr__(name: str):
    ...
    * Removed-module aliases (keys in ``_REMOVED_IN_V17``, such as ``util`` and ``deploy``)
    ...
    if name in _LAZY_TRAINING:
        from geta.tutorials.src.rfdetr import training as _training
    ...
    if name in _PLUS_EXPORTS:
        ...
        from geta.tutorials.src.rfdetr.platform import models as _platform_models
