...
from geta.tutorials.src.rfdetr.assets.coco_classes import COCO_CLASS_NAMES
from geta.tutorials.src.rfdetr.assets.model_weights import download_pretrain_weights
from geta.tutorials.src.rfdetr.config import (
    ModelConfig,
    TrainConfig,
)
from geta.tutorials.src.rfdetr.datasets.coco import is_valid_coco_dataset
from geta.tutorials.src.rfdetr.datasets.yolo import is_valid_yolo_dataset
from geta.tutorials.src.rfdetr.inference import ModelContext, _build_model_context
from geta.tutorials.src.rfdetr.utilities.decorators import deprecated
from geta.tutorials.src.rfdetr.utilities.distributed import is_main_process
...
class RFDETR:
    ...
    def from_checkpoint(cls, path: str | os.PathLike[str], **kwargs: Any) -> RFDETR:
        ...
        import geta.tutorials.src.rfdetr.variants as rfdetr_variants

        _plus_available = False
        _plus_symbols: dict[str, type[RFDETR]] = {}
        _plus_entries: list[tuple[str, type[RFDETR]]] = []
        try:
            import geta.tutorials.src.rfdetr.platform.models as platform_models
        ...
        if model_cls is None:
            ...
            if not _plus_available and (plus_by_model_name or plus_by_weights_name):
                from geta.tutorials.src.rfdetr.platform import _INSTALL_MSG
    ...
    def train(self, **kwargs):
        ...
        * ``do_benchmark`` — emits :class:`DeprecationWarning` and is dropped.
        ...
        try:
            from geta.tutorials.src.rfdetr.training import RFDETRDataModule, RFDETRModelModule, build_trainer
            from geta.tutorials.src.rfdetr.training.auto_batch import resolve_auto_batch_config
    ...
    def export(
        ...
        **kwargs,
        ...
        try:
            from geta.tutorials.src.rfdetr.export.main import export_onnx, make_infer_image
        except ImportError:
            logger.error(
